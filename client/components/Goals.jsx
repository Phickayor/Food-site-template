    ...
    return (
        <div className='py-5 space-y-10 lg:space-y-20'>
            <div className='space-y-4'>
                ...
                <h1 className='text-3xl leading-10 md:text-4xl font-semibold'>Our <span className='text-bordercolor'>Mission</span> & <span className='text-bordercolor'>Vision</span></h1>
            </div >
            <div className='lg:flex lg:space-y-0 space-y-10'>
                <div
                    ...
                    <h1 className="md:text-5xl text-3xl mb-5 font-semibold text-slate-700">Our <span className='text-bordercolor'>Mission</span></h1>
                ...
                <div
                    ...
                    <h1 className="md:text-5xl text-3xl mb-5 font-semibold text-slate-700">Our <span className='text-bordercolor'>Vision</span></h1>
                    <p className='lg:text-lg'>
                        Lorem ipsum dolor sit, amet consectetur adipisicing elit. Suscipit illo saepe similique ad tenetur amet. Vel ex aperiam saepe nulla hic? Eveniet distinctio illum quos officiis expedita molestiae perferendis harum.Lorem ipsum dolor sit, amet consectetur adipisicing elit. Suscipit illo saepe similique ad tenetur amet.
                    </p>
                </div >
