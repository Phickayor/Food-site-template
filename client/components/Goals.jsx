...
function Goals() {
    return (
        <div className='my-10 space-y-10 lg:space-y-20'>
            <div className='space-y-4 my-10'>
                <p className=' px-2 w-fit py-1 border-l-4 bg-slate-200 border-bordercolor'>Our Goals</p>
                <h1 className='text-3xl leading-10 md:text-4xl font-semibold'>Our <b className='text-bordercolor'>Mission</b> and <b className='text-bordercolor'>Vision</b></h1>
            </div>
