...
import { faBars, faClose, faContactCard, faHistory, faHome, faNewspaper, faQuestion, faScroll } from '@fortawesome/free-solid-svg-icons'
        ...
        <div className='sticky z-10 backdrop-blur-md bg-gradient-to-r from-[#651549]  via-bordercolor  to-[#961b0d] w-full top-0 font-semibold px-4 lg:px-10 py-3 text-white'>
            <div className="lg:flex hidden justify-between px-4 lg:px-5">
                ...
                <ul className='flex space-x-5 self-center text-md font-semibold'>
                    ...
                    <Link href='#about' className='hover:border-b-4 border-[#651549] duration-100'><li>About Us</li></Link>
            ...
            <div className={`absolute ${width} duration-[1.5s] bg-gradient-to-br from-[#651549] via-[#961b0d] to-bordercolor top-0 left-0  min-h-screen overflow-x-hidden overflow-y-auto`}>
                ...
                <ul className='flex flex-col space-y-20 px-10 my-14 self-center text-lg font-semibold'>
                    <Link href='/' className='hover:scale-110 duration-100'><li>{home} &nbsp;Home</li></Link>
                    <Link href='/about-us' className='hover:scale-110 duration-100'><li>{about} &nbsp;About Us</li></Link>
                    <Link href='/menu' className='hover:scale-110 duration-100'><li>{menu} &nbsp;Menu</li></Link>
                    <Link href='/contact' className='hover:scale-110 duration-100'><li>{contact} &nbsp; Contact Us</li></Link>
                    <Link href="/faq" className='hover:scale-110 duration-100'><li>{faq} &nbsp; FAQ's</li></Link>
                </ul>
            </div>
        </div>
    )
