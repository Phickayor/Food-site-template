...
function Header() {
    ...
    return (
        <div className='fixed backdrop-blur-md bg-inherit w-full top-0 font-semibold px-4 lg:px-10 py-3 text-white'>
            <div className="lg:flex hidden justify-between px-4 lg:px-5">
                ...
                <ul className='flex space-x-5 self-center text-md font-semibold'>
                    <Link href='/' className='hover:border-b-4 border-bordercolor duration-100'><li>Home</li></Link>
                    <Link href='#about' className='hover:border-b-4 border-bordercolor duration-100'><li>About</li></Link>
                    <Link href='#skills' className='hover:border-b-4 border-bordercolor duration-100'><li>Menu</li></Link>
                    <Link href='/contact' className='hover:border-b-4 border-bordercolor duration-100'><li>Contact Us</li></Link>
                    <Link href="#services" className='hover:border-b-4 border-bordercolor duration-100'><li>FAQ's</li></Link>
                </ul>
                <a href='#contact'>
