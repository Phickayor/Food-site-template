...
function CartComponent() {
    const { IncreaseQuantity, DecreaseQuantity, RemoveCartItem, cart } = useContext(CartContext);
                                ...
                                <div className='flex justify-between mt-4 mx-auto w-11/12'>
                                    <div className='flex gap-x-2 self-center'>
                                        <FontAwesomeIcon
                                            ...
                                            className='cursor-pointer text-3xl text-bordercolor'
                                        />
                                        <h1 className='text-2xl font-semibold'>{item.quantity}</h1>
                                        <FontAwesomeIcon onClick={() => DecreaseQuantity(item.name)} icon={faMinusCircle} className='cursor-pointer text-3xl text-bordercolor' />
                                    </div>
                                    <div className='self-center text-lg font-semibold'>
                                        <h3>₦{item.amount}</h3>
                                    </div>
                                    <div className='self-center flex gap-x-4'>
                                        <FontAwesomeIcon
                                            ...
                                            icon={faTrash}
                                            className='cursor-pointer text-red-500 self-center' />
                                    </div>
                                </div>
